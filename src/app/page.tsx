  ...
  const services = [
    {
      ...
      description: "Complete company registration(PTY LTD), Beneficial ownership(CIPC), Memorandum of Incorporation, and business structuring services tailored to your needs.git ",
      icon: (
      ...
      <Carousel fade interval={4000} controls indicators>
            ...
            <div className={styles.overlay}>
              <Container>
                <Row className="justify-content-center text-center">
                  <Col lg={8}>
                    <h1>About <span className={styles.highlight}>Fiduciary Partners</span></h1>
                    <p>
                      We're a forward-thinking legal services firm dedicated to democratizing access to 
                      quality legal support for businesses of all sizes. Our mission is to remove barriers 
                      and empower entrepreneurs to succeed.
                    </p>
              ...
              <Container>
                <Row className="justify-content-center text-center">
                  <Col lg={8}>
                    ...
                    <p>
                      Comprehensive solutions for startups, SMEs, and corporations seeking strong legal frameworks.
                    </p>
              ...
              <Container>
                <Row className="justify-content-center text-center">
                  <Col lg={8}>
                    ...
                    <p>
                      Protecting your interests with experienced representation in commercial and civil matters.
                    </p>
          ...
          <div className={styles.heroSlide}>
            ...
            <div className={styles.overlay}>
              <Container>
                <Row className="justify-content-center text-center">
                  <Col lg={8}>
                    <h1>Partnership & Trust</h1>
                    <p>
                      Building lasting relationships with our clients through integrity, reliability, and results.
                    </p>
		...
		{/* Hero Content Section */}
			...
			<Row className="align-items-center min-vh-100">
				...
				>
					<h1 className={styles.heroTitle}>Legal Support Without Barriers</h1>
					<p className={styles.heroSubtitle}>
					Comprehensive legal support services, specializing in providing essential
					business documentation, compliance assistance, marketing, and corporate
					structuring services across South Africa.
					</p>
			...
			<Container>
				...
				>
				<h2 className={styles.sectionTitle}>
					Why Choose <span className={styles.highlight}>Fiduciary Partners</span>
				</h2>
				<Row>
