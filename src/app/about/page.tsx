...
const Home = () => {
  ...
  return (
    <Layout>
      <Head>
        <title>Fiduciary Partners - Legal Support Services for South African Businesses</title>
        <meta name="description" content="Professional legal support services for entrepreneurs and businesses. Company formation, compliance, documentation, and business development solutions." />
      </Head>
